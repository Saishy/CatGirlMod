...
public class CatGirlPowerBuff_IncreaseStrikeDamage extends AbstractPower {
    ...
    public CatGirlPowerBuff_IncreaseStrikeDamage(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;

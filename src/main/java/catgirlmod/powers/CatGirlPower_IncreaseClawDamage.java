...
public class CatGirlPower_IncreaseClawDamage extends AbstractPower {
    ...
    public CatGirlPower_IncreaseClawDamage (final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;

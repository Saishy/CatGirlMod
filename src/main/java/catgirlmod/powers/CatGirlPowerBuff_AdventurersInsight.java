...
public class CatGirlPowerBuff_AdventurersInsight extends AbstractPower {
    ...
    public CatGirlPowerBuff_AdventurersInsight(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;

...
public class DefaultOrb extends AbstractOrb {
    ...
    public static final String ORB_ID = CatGirlMod.makeID("CatGirlOrb");
    ...
    public DefaultOrb() {
        ...
        this.img = ImageMaster.loadImage(CatGirlMod.makePath("images/orbs/default_orb.png"));

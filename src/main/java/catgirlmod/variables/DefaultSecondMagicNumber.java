package catgirlmod.variables;

import basemod.abstracts.DynamicVariable;
import com.megacrit.cardcrawl.cards.AbstractCard;
import catgirlmod.cards.AbstractDefaultCard;

import static catgirlmod.CatGirlMod.makeID;
...
public class DefaultSecondMagicNumber extends DynamicVariable {
    ...
    @Override
    public String key() {
        return makeID("SecondMagic"); // This is what you put between "!!" in your card strings to actually display the number.

...
public class CatGirlAction_BloodBathAction extends com.megacrit.cardcrawl.actions.AbstractGameAction {
    private AbstractCreature secondaryTarget;
    private int secondaryDamage;
    private DamageInfo info;
    private static final float DURATION = 0.1F;

    public CatGirlAction_BloodBathAction(AbstractCreature target, AbstractCreature secondaryTarget, DamageInfo info, int secondaryDamage) {
        this.info = info;

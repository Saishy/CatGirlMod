...
public class CatGirlAction_DrawTopCardAndPlayIfType extends AbstractGameAction {

    private boolean exhaustCards;
    private AbstractCard.CardType cardType;

    public CatGirlAction_DrawTopCardAndPlayIfType(AbstractCreature target, AbstractCard.CardType cardType, boolean exhausts) {
    ...
    public CatGirlAction_DrawTopCardAndPlayIfType(AbstractCreature target, AbstractCard.CardType cardType) {

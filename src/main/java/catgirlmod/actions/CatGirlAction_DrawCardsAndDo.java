...
public class CatGirlAction_DrawCardsAndDo extends AbstractGameAction {

    private DrawCardsAndDoCallback callback;

    public interface DrawCardsAndDoCallback {
        void Execute(AbstractCard cardDraw);
    }

    public CatGirlAction_DrawCardsAndDo(DrawCardsAndDoCallback command, int amountToDraw) {

...
public class UpgradeCardTypeInHandAction extends com.megacrit.cardcrawl.actions.AbstractGameAction {
    ...
    public UpgradeCardTypeInHandAction(AbstractCard.CardType cType, UpgradeType upType, int amount) {

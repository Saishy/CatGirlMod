...
public class CatGirlRelic_ThrowingDagger extends CustomRelic {
    ...
    public CatGirlRelic_ThrowingDagger() {
            ...
            if (this.counter % 3 == 0) {
                ...
                AbstractDungeon.actionManager.addToBottom(
                        new ApplyPowerAction(
                                p, p, new CatGirlPowerBuff_Evade(p, p, 2), 2
                        )
                );
            }
        }
    ...
    public AbstractRelic makeCopy() {
        return new CatGirlRelic_ThrowingDagger();
    }
}

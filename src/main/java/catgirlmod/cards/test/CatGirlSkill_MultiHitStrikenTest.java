...
public class CatGirlSkill_MultiHitStrikenTest extends AbstractDefaultCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with CatGirlSkill_MultiHitGashTest
    ...
    public CatGirlSkill_MultiHitStrikenTest() {

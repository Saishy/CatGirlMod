...
public class cardTemplate extends AbstractDefaultCard {
    ...
    public static final String ID = CatGirlMod.makeID("CatGirlCommonAttack"); // CatGirlMod.makeID("${NAME}");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = CatGirlMod.makePath("images/cards/Attack.png"); // CatGirlMod.makePath("images/cards/${NAME}.png")

...
import catgirlmod.actions.IncreaseMagicNumberAction;
...
public class DefensiveStance extends AbstractDefaultCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with DefensiveStance
    ...
    public static final String ID = CatGirlMod.makeID("DefensiveStance");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = "images/cards/Skill.png"; // "images/cards/DefensiveStance.png"

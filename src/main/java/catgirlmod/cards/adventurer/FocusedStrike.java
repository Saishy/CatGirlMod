...
public class FocusedStrike extends AbstractDefaultCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with FocusedStrike
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (p.hasPower(EvadePower.POWER_ID)) {
            AbstractDungeon.actionManager.addToBottom(

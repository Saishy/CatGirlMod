...
public class CatGirlSkill_EmergencyParry extends AbstractDefaultCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with CatGirlSkill_EmergencyParry
    ...
    public static final String ID = CatGirlMod.makeID("CatGirlSkill_EmergencyParry");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = "images/cards/Skill.png"; // "images/cards/CatGirlSkill_EmergencyParry.png"
    ...
    public CatGirlSkill_EmergencyParry() {
        ...
        if (evadePower != null) {
            ...
            AbstractDungeon.actionManager.addToBottom(
                    new com.megacrit.cardcrawl.actions.common.RemoveSpecificPowerAction(
                            p, p, CatGirlPowerBuff_Evade.POWER_ID
                    )
            );

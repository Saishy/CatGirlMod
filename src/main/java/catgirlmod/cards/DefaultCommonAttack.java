...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = CatGirlMod.makeID("CatGirlCommonAttack");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = "images/cards/Attack.png";
    ...
    // Go check out DefaultAttackWithVariable and catgirlmod.variable.DefaultCustomVariable

...
public class CatGirlAttack_ComboAttack extends AbstractDefaultCard {
    ...
    public static final String ID = CatGirlMod.makeID("CatGirlAttack_ComboAttack");
    ...
    public CatGirlAttack_ComboAttack() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new CatGirlAction_DrawTopCardAndPlayIfType(m, CardType.ATTACK)
        );
    }

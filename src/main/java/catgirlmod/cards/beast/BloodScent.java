...
public class BloodScent extends AbstractDefaultCard {
    ...
    public static final String ID = CatGirlMod.makeID("BloodScent");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = "images/cards/Power.png"; // "images/cards/BloodScent.png"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new RemoveSpecificPowerAction(p, p, EvadePower.POWER_ID)
        );
    }

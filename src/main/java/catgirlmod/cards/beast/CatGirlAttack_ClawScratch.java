...
public class CatGirlAttack_ClawScratch extends AbstractDefaultCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with CatGirlAttack_ClawScratch
    ...
    public static final String ID = CatGirlMod.makeID("CatGirlAttack_ClawScratch");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = "images/cards/Attack.png"; // "images/cards/CatGirlAttack_ClawScratch.png"
    ...
    public CatGirlAttack_ClawScratch() {

...
public class CatGirlSkill_Growl extends AbstractDefaultCard {
     ...
     * Read up on the instructions at the bottom. Basically replace anywhere you'd put your cards name with CatGirlSkill_Growl
    ...
    public static final String ID = CatGirlMod.makeID("CatGirlSkill_Growl");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);

    public static final String IMG = "images/cards/Skill.png"; // "images/cards/CatGirlSkill_Growl.png"

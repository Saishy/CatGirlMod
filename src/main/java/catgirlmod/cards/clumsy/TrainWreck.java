...
public class TrainWreck extends AbstractDefaultCard {
    ...
    public static final String IMG = "images/cards/Skill.png"; // "images/cards/TrainWreck.png"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for (AbstractMonster mo : AbstractDungeon.getCurrRoom().monsters.monsters) {
            AbstractDungeon.actionManager.addToBottom(
                    new ApplyPowerAction(mo, p, new StrengthPower(mo, -this.magicNumber), -this.magicNumber, true, AbstractGameAction.AttackEffect.NONE)
            );
        }
